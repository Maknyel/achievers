...
<script>
  ...
  function delete_image(id,name){
      if(confirm("Do you want to delete?")){
        window.location = base_url+'Admin/delete_news?id='+id+'&name='+name;
      }else{
      }
  }
</script>
...
<!-- Modal -->
  ...
  <script type="text/javascript">
    ...
    function upload(){
        ...
        var dataString = new FormData(form);
              $.ajax({
                ...
                contentType: false,
                cache: false,
                url:base_url+"Admin/upload_resume2",
    ...
    $('#close_file').click(function(){
      $.ajax(base_url+'Admin/remove_cropped_thumbnail2', {
            method: "GET",
