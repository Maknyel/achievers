  ...
  <div class="row">
    ...
    <div class="col-12 col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-8">
      <div class="card direct-chat direct-chat-primary">
          ...
          <script type="text/javascript">
            ...
            function addMessages(json,exampleeee) {
              ...
              $.each(json, function(i,val){
                        if(val.user_type == `1`){
                          if($('#agent').val() == val.user_id_messages){
          ...
          <style type="text/css">
            ...
            .nodisplay{
              display: none;
                    ...
                    <div class="row">
                      ...
                      <div class="col-6" style="display: flex">
                        ...
                        <select id="agent" name="agent" class="form-control">
                          <?php foreach (get_employee_all() as $key => $value) { ?>
                            <option value="<?=$value['emp_id']?>"><?=$value['fname']?> <?=$value['lname']?></option>
                          <?php } ?>
                        </select>
                      </div>
                    </div>
                  ...
                  Message: <textarea style="display: none;" name="content" class="form-control" id="content" value=""></textarea>
                  </div> -->
        ...
        <!-- /.card-body -->
        <!-- <div class="card-footer nodisplay" style="width: 100%;text-align: right;display: none;">
