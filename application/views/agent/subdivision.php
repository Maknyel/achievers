              ...
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    ?>
                    <tr>
                      <td><button type="button" onclick="edit_sub(`<?php echo $value['sub_id'] ?>`,`<?php echo $value['sub_name'] ?>`)" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#editsubname">Edit</button>&nbsp;<button type="button" onclick="delete_sub(`<?php echo $value['sub_id'] ?>`)" class="btn btn-danger btn-sm">Delete</button></td>
