            ...
            <div class="row" style="padding: 20px;">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user" method="post" action="<?=base_url()?>Agent/login_submit">
                    <div class="form-group">
                      <input type="email" name="email" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Email" required>
                    </div>
                    <div class="form-group">
...
<div id="forgetpassword" class="modal fade" role="dialog">
  <div class="modal-dialog">
    <form action="<?=base_url()?>Agent/forgetpassword" method="post">
      <!-- Modal content-->
