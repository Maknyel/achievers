          	...
          	<div class="card-body">
                ...
                <table class="table table-bordered" id="table_id" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>
                        <?php if(sales_plan_data($value['sales_id']) != 0){ ?>
                          <a class="btn btn-primary" href="<?=base_url()?>agent/plans/<?=$value['sales_id']?>">View</a>
                        <?php } ?>
                      </td>
                      ...
                      <td><?php echo sales_plan_data_paid($value['sales_id']) ?>/ <?php echo sales_plan_data($value['sales_id']) ?></td>
