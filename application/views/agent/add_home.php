                ...
                <div class="row">
                  <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" id="house_decs" name="house_decs" autocomplete="off" required>
                        </textarea>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" id="address" name="address" autocomplete="off" required>
                        </textarea>
                      </div>
                      <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="tota_contart_price" name="tota_contart_price" autocomplete="off" required>
                      </div>
